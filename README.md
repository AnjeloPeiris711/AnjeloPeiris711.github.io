...
<h1 style="color:green; writing-mode: vertical-rl;margin-right: 4rem">I made this project just for fun,</h1><h2 style="color:red; writing-mode: vertical-rl; margin-right: 3rem">it allows me to create nice and simple blog</h2>
